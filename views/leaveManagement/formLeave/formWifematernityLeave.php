  ...
  <div class="content-wrapper">
    ...
    <div class="container">
            <div class="card card-register mx-auto mt-5">
              <div class="card-header"><center>แบบฟอร์มลาไปช่วยเหลือภริยาที่คลอดบุตร</center></div>
              <div class="card-body">
                <form>
                  ...
                  <div class="form-group">
                    <div class="form-row">
                        ...
                        <div class="col-md-6">
                            <label for="exampleInputName">มีความประสงค์ลาไปช่วยเหลือภริยาโดยชอบด้วยกฎหมายชื่อ</label>
                            <input class="form-control" id="exampleInputName" type="text" aria-describedby="nameHelp" placeholder="ขออนุญาติการลา">
                        </div>
                        <div class="col-md-6">
                            <label for="exampleInputName">จึงขออนุญาติลาไปช่วยเหลือภริยาที่คลอดบุตรตั้งแต่วันที่</label>
                        ...
                        <div class="col-md-6">
                            <label for="exampleInputName">ซึ่งคลอดบุตรเมื่อวันที่</label>
                            <input class="form-control" id="exampleInputName" type="date" aria-describedby="nameHelp">
                        </div>
                        <div class="col-md-6">
                            <label for="exampleInputName">มีกำหนด</label>
                            <input class="form-control" id="exampleInputName" type="number" aria-describedby="nameHelp" placeholder="วันทำการ">
                        </div>
                        <div class="col-md-6">
