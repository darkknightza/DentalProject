  ...
  <div class="content-wrapper">
    ...
    <div class="container">
            <div class="card card-register mx-auto mt-5">
              <div class="card-header"><center>แบบฟอร์มลาเข้ารับการตรวจเลือกหรือเข้ารับการเตรียมพล</center></div>
              <div class="card-body">
                <form>
                  ...
                  <div class="form-group">
                    <div class="form-row">
                        ...
                        <div class="col-md-6">
                            <label for="exampleInputName">ได้รับหมายเรียกของ</label>
                            <input class="form-control" id="exampleInputName" type="text" aria-describedby="nameHelp">
                        </div>
                        
                        <div class="col-md-6">
                            <label for="exampleInputName">ลงวันที่</label>
                            <input class="form-control" id="exampleInputName" type="text" aria-describedby="nameHelp">
                        </div>
                        <div class="col-md-12">
                            <label for="exampleInputName">ที่</label>
                            <input class="form-control" id="exampleInputName" type="text" aria-describedby="nameHelp">
                        </div>
                        <div class="col-md-12">
                            <label for="exampleInputName">ให้เข้ารับราชการทหารตามกฎหมายว่าด้วยการรับราชการทหาร</label>
                            <input class="form-control" id="exampleInputName" type="text" aria-describedby="nameHelp">
                        </div>
                        <div class="col-md-12">
                            <label for="exampleInputName">ณ ที่</label>
                            <input class="form-control" id="exampleInputName" type="text" aria-describedby="nameHelp">
